...
const SwitchButton = props => {
    return(
        <div className={"switch-button"}>
            <input className={"switch-button__input"} type={"checkbox"} id={props.id} readOnly checked={props.checked}></input>
            <label className={"switch-button__label"} htmlFor={props.id} onClick={props.onChange}>
